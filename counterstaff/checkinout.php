...
$query = "SELECT checkinoutid,date,checkintime,checkouttime,
            ...
            FROM pdms.empcheckinout ch where (select branchid from employee where
            employeeid=ch.employeeid)='$branchid' order by date desc;";
$result = $con->query($query);
while ($row = $result->fetch_assoc()) {
    $checkinouts[] = $row;
}

$query2 = "select employeeid,concat(firstname,' ',lastname) as name from employee where branchid='$branchid' ";
        ...
        <ul>
            ...
            <li>
                <a href="../Employee/checkInOut.php" class="nav-list-item">
                    <i class="fa-solid fa-clock sideBarIcon"></i>
