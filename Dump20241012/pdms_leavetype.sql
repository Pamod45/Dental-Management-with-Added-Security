...
CREATE TABLE `leavetype` (
  `leavetypeid` varchar(6) NOT NULL,
...
INSERT INTO `leavetype` VALUES ('LT001','Half Day: mor',NULL),('LT002','Half Day: eve',NULL),('LT003','Full Day',NULL),('LT004','Priviladge Leave',NULL);
