...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        cmonth.addEventListener("change", function() {
            ...
            if (selectedMonth.length >= 1) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'getExpenses.php', // Update this with the correct path to your PHP script
                    data: {
                        year: selectedYear,
                        month: selectedMonth,
                    },
    ...
    function fillTable(data) {
        ...
        row.innerHTML = `
                    <td class="large fw-bold">Total Expense</td>
